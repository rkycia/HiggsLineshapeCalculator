...
\mainpage ISR Higgs lineshape calculator, MPI version
...
It plots corss section vs energy spread dependence.


\warning
1. The programs were written by means of high standards, however, author is not responsible for any damages that result from the use of these program. Use them at your own risk.
2. If you have any comments, suggestions, questions please write. I will try to answer them in reasonable time.
...
There are following options (type in terminal to see the output):
 ...
 - make run - compile and run program. For adjusting number of processes modify constant NOP in Makefile
